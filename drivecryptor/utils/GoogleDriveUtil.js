...
import { GDrive, ListQueryBuilder, MimeTypes, Uploader } from '@robinbobin/react-native-google-drive-api-wrapper';
...
const createConfigFileIfNotExists = async (instance) => {
  ...
  if (found === false) {
    ...
    let id = await instance.files.newMultipartUploader()
