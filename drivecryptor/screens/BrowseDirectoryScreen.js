  ...
  return (
    <>
      <View className="flex-row items-center justify-between px-4 py-4 bg-flat_blue2 mb-2">
        ...
        <CheckIcon color="white" fill="white" size={30} onPress={doneSelecting}/>
        
      </View>
      <FlatList
        data={fileList}
        renderItem={(item) => <FileListCard navigation={navigation} item={item} redirectScreen="BrowseDirectoryScreen" selectedFileToUpload={selectedFileToUpload}/>}
