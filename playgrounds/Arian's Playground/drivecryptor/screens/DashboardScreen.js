...
import { UserMinusIcon, FolderIcon, ArrowUpOnSquareStackIcon, CameraIcon, QueueListIcon } from "react-native-heroicons/solid";
  ...
  return (
    <>
      ...
      <View>
        ...
        <Pressable onPress={() => Linking.openURL("drivecryptor://app/allqueue?key=category_parent_id")}>
          <DashboardCardItem title="All Task Queue" >
            <QueueListIcon color="white" fill={color_theme.flat_white1} size={35} />
          </DashboardCardItem>
        </Pressable>
